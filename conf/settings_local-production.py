...
DATABASES = {
    'default': {
        ...
        'NAME': 'medill2010_radregator_production', # Or path to database file if using sqlite3.
        'USER': 'medill2010_radregator_production', # Not used with sqlite3.
...
LOG_FILENAME = "/home/medill2010/logs/user/sourcerer-production.log"
