...
DATABASES = {
    'default': {
        ...
        'NAME': 'sourcerer', # Or path to database file if using sqlite3.
        'USER': 'sourcerer', # Not used with sqlite3.
        'PASSWORD': 'ChangeMeForReal',                  # Not used with sqlite3.
...
MEDIA_URL = 'http://sourcerer-static-production.s3-website-us-east-1.amazonaws.com/media/'

# URL prefix for admin media -- CSS, JavaScript and images. Make sure to use a
# trailing slash.
# Examples: "http://foo.com/media/", "/media/".
ADMIN_MEDIA_PREFIX = 'http://sourcerer-static-production.s3-website-us-east-1.amazonaws.com/admin/'
...
LOG_FILENAME = "/var/sourcerer-logs/sourcerer-production.log"
