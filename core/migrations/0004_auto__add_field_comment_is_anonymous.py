...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.is_anonymous'
        db.add_column('core_comment', 'is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.is_anonymous'
        db.delete_column('core_comment', 'is_anonymous')
