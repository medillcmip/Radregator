...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field clips on 'Comment'
        db.create_table('core_comment_clips', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comment', models.ForeignKey(orm['core.comment'], null=False)),
            ('clip', models.ForeignKey(orm['clipper.clip'], null=False))
        ))
        db.create_unique('core_comment_clips', ['comment_id', 'clip_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field clips on 'Comment'
        db.delete_table('core_comment_clips')
