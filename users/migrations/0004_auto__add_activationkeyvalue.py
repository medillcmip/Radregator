...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ActivationKeyValue'
        db.create_table('users_activationkeyvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('activation_key', self.gf('django.db.models.fields.TextField')(unique=True)),
        ))
        db.send_create_signal('users', ['ActivationKeyValue'])


    def backwards(self, orm):
        
        # Deleting model 'ActivationKeyValue'
        db.delete_table('users_activationkeyvalue')
    ...
    models = {
        ...
        'users.activationkeyvalue': {
            'Meta': {'object_name': 'ActivationKeyValue'},
            'activation_key': ('django.db.models.fields.TextField', [], {'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
