...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_userprofile', (
            ...
            ('facebook_user_id', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('street_address', self.gf('django.db.models.fields.TextField')(blank=True)),
            ...
            ('user_type', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('is_verified', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('reporter_verified', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile'], null=True, blank=True)),
        ))
