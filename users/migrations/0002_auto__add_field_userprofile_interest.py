...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.interest'
        db.add_column('users_userprofile', 'interest', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.interest'
        db.delete_column('users_userprofile', 'interest')
